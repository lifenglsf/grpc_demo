...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=hw.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x68, 0x77, 0x22, 0x89, 0x02, 0x0a, 0x06, 0x53,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x68, 0x77, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x68, 0x77, 0x2e, 0x53, 0x63,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: hw.Screen.Panel
	(*Screen)(nil),            // 1: hw.Screen
	(*Screen_Resolution)(nil), // 2: hw.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: hw.Screen.resolution:type_name -> hw.Screen.Resolution
	0, // 1: hw.Screen.panel:type_name -> hw.Screen.Panel
